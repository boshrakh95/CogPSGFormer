...
# An updated version of EEG_spectral_feature_extraction_STAGES_v2.py for raw data
# Pre-process and save EEG signals from the STAGES dataset
...
for clinic in clinics:
    ...
    directory3 = "eeg_segmented_30sec/"
        ...
        if results:
            ...
            if len(filtered_data) > 0:
                ...
                for ind in range(len(eeg_channels)):
                    np.save(os.path.join(path_sbj, 'eeg_' + eeg_channels[ind] + '_segmented_30sec.npy'),
